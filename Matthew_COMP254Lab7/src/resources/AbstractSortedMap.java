...
public abstract class AbstractSortedMap<K,V>
  ...
  protected boolean checkKey(K key) throws IllegalArgumentException {
    ...
    public abstract V get(K key, TreeMap<K, V> map) throws IllegalArgumentException;

    public abstract V put(K key, V value, TreeMap<K, V> map) throws IllegalArgumentException;

    public abstract V remove(K key, TreeMap<K, V> map) throws IllegalArgumentException;

    public abstract Entry<K, V> ceilingEntry(K key, TreeMap<K, V> map) throws IllegalArgumentException;

    public abstract Entry<K, V> floorEntry(K key, TreeMap<K, V> map) throws IllegalArgumentException;

    public abstract Entry<K, V> lowerEntry(K key, TreeMap<K, V> map) throws IllegalArgumentException;

    public abstract Entry<K, V> higherEntry(K key, TreeMap<K, V> map) throws IllegalArgumentException;
}
